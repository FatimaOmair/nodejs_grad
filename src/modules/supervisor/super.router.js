...
import { assignTask, confirm, editProfile, getMySections, giveFeedback, reject, viewProfile } from "./super.controller.js";
...
router.put('/editProfile', auth([role.supervisor]), editProfile);
