...
export const reject = async (req, res, next) => {
    ...
    try {
     const request = await requestModel.findByIdAndUpdate(req.body.requestId,{state:"rejected"},{new:true});
  ...
  export const confirm = async (req, res, next) => {
    ...
    try {
     ...
     const request = await requestModel.findByIdAndUpdate(req.body.requestId,{state:"accept"},{new:true});
